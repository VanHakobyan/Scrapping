...
namespace AutoWini
{
    public class Parser
    {
        private const string KiaK5Url = @"http://www.autowini.com/Cars/Kia-K5/car-search.do?i_sIndexVal=bq&i_sSearchType=quick&startYear=2009&endYear=2015&sPriceFrom=2500&sPriceTo=3500";
